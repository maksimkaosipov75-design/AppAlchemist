...
Result: `build/appalchemist_1.6.1-1_amd64.deb`
...
Result: `build/rpmbuild/RPMS/x86_64/appalchemist-1.6.1-1.x86_64.rpm`
...
Result: `appalchemist-1.6.1-1-x86_64.pkg.tar.zst`

## Installing Packages

### DEB
```bash
sudo dpkg -i build/appalchemist_1.6.1-1_amd64.deb
sudo apt-get install -f  # Install dependencies if needed
```

### RPM
```bash
sudo rpm -ivh build/rpmbuild/RPMS/x86_64/appalchemist-1.6.1-1.x86_64.rpm
```

### Arch
```bash
sudo pacman -U appalchemist-1.6.1-1-x86_64.pkg.tar.zst
```
